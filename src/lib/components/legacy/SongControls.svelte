...
<div class="song-controls h-full flex flex-col justify-center" style="color: {theme.primary};">
  <div class="song-name text-center mb-3 px-2 truncate">
    {activeTrackTitle}
  </div>
  
  <div class="time text-center mb-4">
    {formatTime(currentTime)} / {formatTime(totalDuration)}
  </div>
  
  <div class="control-buttons flex justify-center items-center gap-4">
    <button 
      class="nav-button" 
