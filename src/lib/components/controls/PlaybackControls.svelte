		...
		>
			...
			>
				<path 
					...
					fill={$playlist.isRepeatMode ? theme.background : theme.primary} 
				/>
			</svg>
		</button>
		...
		>
			...
			>
				<path 
					...
					fill={$playlist.isShuffleMode ? theme.background : theme.primary} 
				/>
			</svg>
		</button>
		...
		>
			{#if $isPlaying}
				<svg
					...
					xmlns="http://www.w3.org/2000/svg"
				>
					<rect x="6" y="4" width="4" height="16" rx="1" fill={theme.background} />
					<rect x="14" y="4" width="4" height="16" rx="1" fill={theme.background} />
				</svg>
			{:else}
				<svg
					class="md:scale-100 lg:scale-125"
